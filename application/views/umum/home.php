      ...
      <div class="row">
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div data-aos="zoom-out">
            <h1>Pemilihan ketua RT 005 dengan <span>Evoting</span></h1>
            <h2>Votingmu adalah masa depan lingkungan kita</h2>
        ...
        <div class="col-lg-5 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="300">
          <img src="<?= base_url('assets/umum/') ;?>assets/img/hero-aja.png" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-xl-5 col-lg-6 video-box d-flex justify-content-center align-items-stretch" data-aos="fade-right">
            <img src="<?= base_url('assets/umum/') ;?>assets/img/about2.png" class="img-fluid animated" alt="">
            <a href="#" class="venobox play-btn mb-4" data-vbtype="video" data-autoplay="true"></a>
          </div>

          <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5" data-aos="fade-left">
            <h3>Tata cara melakukan pemilihan dengan Evoting</h3>
        ...
        <div class="row" data-aos="fade-left">
          ...
          <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
            <div class="icon-box" data-aos="zoom-in" data-aos-delay="100">
              ...
              <h3><a href="">Hasil sementara</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
            <div class="icon-box" data-aos="zoom-in" data-aos-delay="150">
              <i class="ri-calendar-todo-line" style="color: #e80368;"></i>
              <h3><a href="">Jadwal</a></h3>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4 mt-4">
            <div class="icon-box" data-aos="zoom-in" data-aos-delay="350">
              ...
              <h3><a href="">Daftar Calon RT</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4">
