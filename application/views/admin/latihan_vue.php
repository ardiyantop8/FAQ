<ul class="nav justify-content-center bg-dark text-light">
    <li class="nav-item">
        <a class="nav-link text-white h4" href="<?php echo base_url("Admin/Latihan_vue"); ?>">Codeigniter Vue JS <img src="<?php echo base_url(); ?>assets/img/civue.png" width="60" height="70"></a>
    </li>
</ul>
<div id="app-berita">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <table class="table bg-dark my-3" style="border-radius:20px;">
                    <tr>
                        <td> <button class="btn btn-default btn-block" @click="addModal= true">Add</button></td>
                        <td> <button class="btn btn-primary btn-block" @click="addModal2= true">Add Test</button></td>
        ...
        <pagination :current_page="currentPage" :row_count_page="rowCountPage" @page-update="pageUpdate" :total_users="totalUsers" :page_range="pageRange">
        </pagination>
    </div>
